/*
 * settings_pigun.h - Set for Pigun
 * This file is part of the g2core project
 *
 * Copyright (c) 2012 - 2016 Alden S. Hart, Jr.
 * Copyright (c) 2016 Jakub Osika
 *
...
#ifndef INIT_MESSAGE
#define INIT_MESSAGE "Initializing configs to pigun settings"
#endif
...
#define M1_TRAVEL_PER_REV           6.54545454              // 360degrees for 55 rotations {1tr:  1.25 is a typical value for a screw axis 
#endif
...
#define M2_TRAVEL_PER_REV           1.25   // M8 - 1.25
#endif
...
#define X_VELOCITY_MAX              12000.0                  // {xvm:  G0 max velocity in mm/min
#endif
#ifndef X_FEEDRATE_MAX
#define X_FEEDRATE_MAX              3142.0                  // {xfr:  G1 max feed rate in mm/min
#endif
#ifndef X_TRAVEL_MIN
#define X_TRAVEL_MIN                -100.0                     // {xtn:  minimum travel for soft limits
#endif
#ifndef X_TRAVEL_MAX
#define X_TRAVEL_MAX                100.0                     // {xtm:  travel between switches or crashes
#endif
#ifndef X_JERK_MAX
#define X_JERK_MAX                  15000.0                  // {xjm:
#endif
#ifndef X_JERK_HIGH_SPEED
#define X_JERK_HIGH_SPEED           15000.0                  // {xjh:
#endif
...
#define X_LATCH_BACKOFF             8.0                     // {xlb:  mm
#endif
#ifndef X_ZERO_BACKOFF
#define X_ZERO_BACKOFF              146.0                     // {xzb:  mm
#endif
...
#define Y_VELOCITY_MAX              2400.0                   //(24V = 600, 12V = 200)
#endif
#ifndef Y_FEEDRATE_MAX
#define Y_FEEDRATE_MAX              600.0
#endif
#ifndef Y_TRAVEL_MIN
#define Y_TRAVEL_MIN                -20.0
#endif
#ifndef Y_TRAVEL_MAX
#define Y_TRAVEL_MAX                73.0
#endif
#ifndef Y_JERK_MAX
...
#define Y_SEARCH_VELOCITY           300.0
#endif
