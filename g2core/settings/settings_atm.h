...
#define QUEUE_REPORT_VERBOSITY      QR_TRIPLE                  // {qv: QR_OFF, QR_SINGLE, QR_TRIPLE
#endif
...
#define M1_STEPS_PER_UNIT           320                       // {1su:  steps to issue per unit of length or degrees of rotation
#endif
#ifndef M1_POLARITY
...
#define M2_TRAVEL_PER_REV           1.25                    // {1tr:  1.25 is a typical value for a screw axis
#endif
#ifndef M2_MICROSTEPS
#define M2_MICROSTEPS               8                       // {1mi:  1,2,4,8,    16,32 (G2 ONLY)
#endif
#ifndef M2_STEPS_PER_UNIT
#define M2_STEPS_PER_UNIT           320                       // {1su:  steps to issue per unit of length or degrees of rotation
#endif
#ifndef M2_POLARITY
...
#define M3_TRAVEL_PER_REV           1.25                    // {1tr:  1.25 is a typical value for a screw axis
#endif
#ifndef M3_MICROSTEPS
#define M3_MICROSTEPS               8                       // {1mi:  1,2,4,8,    16,32 (G2 ONLY)
#endif
#ifndef M3_STEPS_PER_UNIT
#define M3_STEPS_PER_UNIT           320                       // {1su:  steps to issue per unit of length or degrees of rotation
#endif
#ifndef M3_POLARITY
...
#define X_JERK_HIGH_SPEED           800.0                  // {xjh:
#endif
...
#define Y_JERK_HIGH_SPEED           800.0
#endif
...
#define Z_JERK_HIGH_SPEED           800.0
#endif
